...
public class CadastroPacienteSUS extends JFrame {
	...
	private JTextField numeroCadastroSUS;

	public CadastroPacienteSUS() {
		...
		JLabel lblNewLabel = new JLabel("Cadastro Paciente SUS");
		...
		JLabel lblNewLabel_7 = new JLabel("N\u00BA de Cadastro SUS");
		lblNewLabel_7.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblNewLabel_7, "4, 10, center, default");
		
		numeroCadastroSUS = new JTextField();
		numeroCadastroSUS.setColumns(10);
		contentPane.add(numeroCadastroSUS, "6, 10, fill, default");
		...
		contentPane.add(btnNewButton, "4, 13");
		
		JButton btnNewButton_1 = new JButton("Cadastrar");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					new PacienteSUS(nome.getText(), cpf.getText(), dataNascimento.getText(), endereco.getText(), telefone.getText(), email.getText(), numeroCadastroSUS.getText());
		...
		contentPane.add(btnNewButton_1, "6, 13");
	}
